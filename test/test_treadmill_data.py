...
class TestTreadmillData(unittest.TestCase):
    def test_empty_init(self):
        ...
        self.assertEqual(tmd.abs_position, 0)
        self.assertEqual(tmd.lap, 0)
        self.assertEqual(tmd.rel_position, 0)
        self.assertEqual(tmd.lick, 0)
        self.assertEqual(tmd.initialized, 0)
        self.assertListEqual(tmd.port_states, [0, 0, 0])
    ...
    def test_init_with_values(self):
        ...
        self.assertEqual(tmd.abs_position, 4)
        self.assertEqual(tmd.lap, 5)
        self.assertEqual(tmd.rel_position, 6)
        self.assertEqual(tmd.lick, 7)
        self.assertEqual(tmd.initialized, 8)
        self.assertListEqual(tmd.port_states, [1, 2, 3])
